# catalogo_ar.py
# 2024-05-17 (Actualizado v3 - calibración Dry Irish Stout)
# Autor: SaintWick
"""
...
v3: + Lallemand Nottingham y Cebada Tostada (Roasted Barley) para la ficha
de calibración Dry Irish Stout (pedido Stephan 15/9).
"""
...
MALTAS_AR = {
    ...
    # --- Tostadas (v3: calibración Dry Irish Stout) ---
    "Cebada Tostada (Roasted Barley)": {"extracto": 250, "color": 500.0},
}
...
# ==========================================
# 4. LEVADURAS (§4 - Fermentis, Mangrove Jack's y Lallemand)
# ==========================================
...
LEVADURAS_AR = {
    ...
    # --- Lallemand (v3: calibración Dry Irish Stout) ---
    "Lallemand Nottingham (Ale Inglesa)": {"atenuacion": 80.0, "tolerancia_abv": 12.0},
}
